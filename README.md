Module2_EDA_Submission.ipynb = File where all the wrangling and visualisations take place
...
UPDATE:
Added a .pbix file which has different kinds of visualisations from which useful insights can be drawn.
